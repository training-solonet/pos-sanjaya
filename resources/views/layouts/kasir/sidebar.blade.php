<div id="sidebar"
    class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg h-screen
           ...
           lg:translate-x-0 lg:relative lg:sticky lg:top-0 lg:h-screen lg:flex-shrink-0 flex flex-col">
    ...
    <div class="p-4 border-t border-gray-200">
        <div class="flex items-center space-x-3">
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center hover:bg-red-100 hover:text-red-600 transition-colors">
