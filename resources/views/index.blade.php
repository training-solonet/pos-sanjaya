            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div class="text-center lg:text-left animate-slide-in">
                    <div class="mb-8">
                        ...
                        >
                            <i
                                class="fas fa-cash-register text-white text-3xl"
                            ></i>
                        </div>
                        <h1
                            class="text-4xl lg:text-5xl font-bold text-white mb-4"
                        >
                            POS Sanjaya
                        </h1>
                        ...
                        <p class="text-white/60 leading-relaxed">
                            Kelola bisnis restoran Anda dengan mudah menggunakan
                            sistem POS yang terintegrasi. Pantau penjualan,
                            kelola stok, dan analisa performa bisnis dalam satu
                            platform.
                        </p>
                    </div>
                ...
                <div class="animate-fade-in">
                    <div
                        class="glass-effect rounded-3xl p-8 lg:p-10 shadow-2xl"
                    >
                        ...
                        <form id="loginForm" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex items-center">
                                    ...
                                    <div class="relative">
                                        <div
                                            class="w-4 h-4 bg-white/20 border border-white/30 rounded"
                                        ></div>
                                        <div
        ...
        <script>
            ...
            function fillDemoAccount(username, password) {
                ...
                inputs.forEach((input) => {
                    input.classList.add("ring-2", "ring-green-300/50");
                    setTimeout(() => {
                        input.classList.remove("ring-2", "ring-green-300/50");
                    }, 1000);
                });
            }
            ...
            document
                ...
                .addEventListener("submit", function (e) {
                    ...
                    setTimeout(() => {
                        // Automatic redirect based on username
                        if (
                            username.toLowerCase() === "manajemen" ||
                            username.toLowerCase() === "admin"
                        ) {
                            // Kirim request login untuk manajemen
                            submitLoginForm(username, password, "manajemen");
                            return;
                        } else if (username.toLowerCase() === "kasir") {
                            // Kirim request login untuk kasir
                            submitLoginForm(username, password, "kasir");
                            return;
                        }

                        // Untuk username lain, tentukan role berdasarkan credentials
                        let role = "kasir"; // default
                        if (username === "admin" && password === "admin123") {
                            role = "manajemen";
                        }

                        submitLoginForm(username, password, role);
                    }, 2000);
                });

            // Function untuk submit form login ke Laravel
            function submitLoginForm(username, password, role) {
                // Buat form data
                const formData = new FormData();
                formData.append("username", username);
                formData.append("password", password);
                formData.append("_token", getCSRFToken()); // Anda perlu mendapatkan CSRF token
            ...
            // Function untuk mendapatkan CSRF token (tambahkan meta tag di head)
            ...
            // Quick redirect functions
            function redirectToKasir() {
                // Store user info as kasir
            ...
            function redirectToManajemen() {
                // Store user info as admin
                localStorage.setItem(
                    "posUser",
                    JSON.stringify({
                        username: "admin",
