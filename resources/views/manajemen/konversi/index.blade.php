...
<head>
    ...
    <title>Konversi Satuan Bahan Baku - POS Sanjaya</title>
...
<body class="bg-gray-50 min-h-screen lg:flex">
    ...
    <div id="sidebar" class="sidebar fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:relative lg:flex-shrink-0">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route("manajemen_konversi") }}" class="nav-item group flex items-center px-3 py-3 text-sm font-medium text-white bg-gradient-to-r from-green-400 to-green-700 rounded-lg">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
            <div class="flex items-center space-x-3">
                ...
                <button class="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100">
                    ...
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <div class="w-12 h-12 bg-gradient-to-r from-green-400 to-green-700 bg-opacity-10 rounded-xl flex items-center justify-center">
                                    <i class="fas fa-cube text-white text-xl"></i>
                                </div>
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900">Konversi Satuan</h2>
                                    <p class="text-sm text-gray-500">Buat dan kelola satuan untuk kebutuhan bisnis Anda</p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-2">
                                <button onclick="swapUnits()" class="p-2 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 transition-colors">
                                    <i class="fas fa-sync-alt"></i>
                                </button>
                                <button onclick="clearAll()" class="p-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition-colors">
                    ...
                    <div class="p-6">
                        ...
                        <div id="customUnitManager" class="hidden mb-6 p-4 bg-green-50 border border-green-200 rounded-xl">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-gray-900">Konversi Satuan</h3>
                                <button onclick="showAddUnitForm()" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                                    ...
                                    <div class="px-6 py-4 border-b border-gray-200">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <button onclick="hideAddUnitForm()" class="text-gray-400 hover:text-gray-600">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        </div>
                                        <p class="text-sm text-gray-500 mt-1">Isi form di bawah untuk menambah satuan baru</p>
                                    </div>
                                    ...
                                    <div class="px-6 py-6">
                                        <div class="space-y-5">
                                            ...
                                            <div>
                                                ...
                                                >
                                                <p class="text-xs text-gray-500 mt-1">Nama kemasan yang akan digunakan</p>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                >
                                                <p class="text-xs text-gray-500 mt-1">Singkatan untuk kemudahan (maks 8 huruf)</p>
                                            </div>
                                                ...
                                                <div class="bg-gray-50 rounded-lg p-4 mb-3">
                                                    <div class="text-center">
                                                        <div class="text-lg font-medium text-gray-700">
                                                            1 <span id="unitNameDisplay" class="text-green-600 font-bold">Kemasan</span> = 
                                                            <span id="factorDisplay" class="text-green-600 font-bold">?</span> 
                        ...
                        <!-- Result Summary -->
                        <div id="resultSummary" class="mt-6 p-4 bg-gradient-to-r from-primary/5 to-secondary/5 rounded-xl border border-primary/10 hidden">
                            <div class="flex items-center space-x-3">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100">
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex items-center justify-between">
                            ...
                            <button onclick="clearHistory()" class="p-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition-colors">
    ...
    <div id="sidebarOverlay" class="fixed inset-0 bg-black opacity-50 z-40 lg:hidden hidden" onclick="toggleSidebar()"></div>
    ...
    <script>
        ...
        function loadCustomUnits() {
            ...
            if (customUnits.length === 0) {
                const defaultUnits = [
                    { name: 'Krat Telur', code: 'krat', factor: 30, baseUnit: 'pcs', id: 1 },
                    { name: 'Dus Mie', code: 'dus', factor: 40, baseUnit: 'pcs', id: 2 },
                    { name: 'Karung Beras', code: 'karung', factor: 25, baseUnit: 'kg', id: 3 },
                    { name: 'Jerigen Minyak', code: 'jerigen', factor: 5, baseUnit: 'L', id: 4 }
                ];
        ...
        function editCustomUnit(code) {
            ...
            if (unit) {
                ...
                form.querySelector('button[onclick="addCustomUnit()"]').innerHTML = '<i class="fas fa-save mr-2"></i>Update';
            }
        }
