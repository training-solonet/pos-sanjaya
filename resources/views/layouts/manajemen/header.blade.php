              ...
              <div x-show="open" 
                ...
                <div class="max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  @forelse($notifications as $notif)
                    <div class="block px-5 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 cursor-pointer group">
                          ...
                          @if($notif['type'] === 'bahan_baku')
                            ...
                            @else
                              <div class="w-12 h-12 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-xl flex items-center justify-center shadow-sm">
                                <i class="fas fa-box text-yellow-600 text-lg"></i>
                              </div>
                            @endif
                          @else
                            @if($notif['color'] === 'red')
